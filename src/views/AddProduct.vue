      ...
      <div class="row">
        <div class="col">
          <div
            ...
            role="alert"
            v-if="submitted"
          >Your product has been submitted</div>
      ...
      <div class="row" v-if="!submitted">
        <div class="col">
          <form action>
            ...
            <input type="text" id="product_Name" v-model.lazy="product.prod_name" required />
            <label for="product_price">Product Price</label>
            <input type="number" id="product_price" v-model.lazy="product.prod_price" required />
            ...
            <select name="seller" id="product_seller" v-model="product.prod_seller">
              <option v-for="(seller, prod_cat) in prod_sellers" :key="prod_cat">{{ seller }}</option>
            </select>
