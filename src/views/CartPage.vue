<template>
  <div class="container">
    <div class="text-center">
      <h1 class="mt-4 mb-2">Your Cart</h1>
    </div>
    <div class="row">
      <div class="col">
        <div class="alert alert-info mt-5" role="alert" v-if="!cartItems.length">Your art is empty!</div>
      </div>
    </div>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(cartItem, item) in cartItems" :key="item">
                ...
                <td>
                  <button class="border-0 btn-sm mr-2" v-on:click="removeQty(cartItem)">Remove</button>
                  {{ cartItem.qty
                  }}
                  <button
                ...
                <td>
                  <button class="btn-danger btn-sm" v-on:click="removeItem(cartItem)">Remove</button>
                </td>
              </tr>
              <tr>
